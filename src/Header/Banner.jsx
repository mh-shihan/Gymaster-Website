  ...
  return (
    <div className=" relative">
      ...
      <div className="absolute inset-0 top-[30%] text-white space-y-3     ">
        <h3 className="text-center text-xl md:text-3xl text-orange-500 font-bold">
          BEST GYM CENTER
        </h3>
        <h2 className="text-center text-2xl md:text-5xl xl:text-6xl font-bold md:font-extrabold">
